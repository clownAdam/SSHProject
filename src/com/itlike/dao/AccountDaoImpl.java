...
public class AccountDaoImpl extends HibernateDaoSupport implements AccountDao  {
    ...
    public void save(Account account) {
        System.out.println("AccountDaoImpl 保存数据到数据库当中 dao");
...
//        List<Account> account = (List<Account>) this.getHibernateTemplate().find("from Account");
        DetachedCriteria criteria = DetachedCriteria.forClass(Account.class);
        List<Account> account = (List<Account>) this.getHibernateTemplate().findByCriteria(criteria);
        return account;
    }
}
